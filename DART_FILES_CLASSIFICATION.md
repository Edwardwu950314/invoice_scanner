...
### 建議 1：補充 Models/DTOs 層
```
features/scanner/data/models/
  ├── invoice_dto.dart          # API 響應模型
  └── scan_result_model.dart    # 掃描結果模型
```

### 建議 2：提取共用 Providers
```
lib/shared/providers/
  ├── api_provider.dart         # API 通訊 Provider
  └── storage_provider.dart     # 存儲 Provider
```

### 建議 3：添加 Exceptions 層
```
lib/core/exceptions/
  ├── api_exception.dart
